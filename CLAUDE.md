...
│   ├── admin_data_sources.html # /admin/data_sources admin panel (ladmin's ONLY page: sidebar nav incl. Relations — confirmed-relations overview + persistent Recommended-tables block (v4) + discovery — 3-step register wizard with auto-suggested relations at step 3, the v4.2 #recAcceptModal type-choice dialog reusing the #pwModal narrow-modal chrome, a muted build stamp in the sidebar footer, standalone CSS/JS)
