...
│   ├── admin_data_sources.html # /admin/data_sources admin panel (ladmin's ONLY page: sidebar nav incl. Discover relations, 3-step register wizard, standalone CSS/JS)
