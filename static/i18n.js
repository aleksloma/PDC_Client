...
window.I18N_TRANSLATIONS = {
  en: {
    ...
    'lab.refresh_no_access': "Your role doesn't include this table's data — refresh is unavailable. Showing the last saved result.",
    ...
    'wizard.db_already_in_chat': 'Already in this chat',
    ...
    'dash.add_header': '＋ Header',
    'dash.add_text_title': 'Text block',
    'dash.edit_text': 'Edit text',
    'dash.text_placeholder': 'Your text…',
    'dash.text_style': 'Style',
    'dash.text_size': 'Size',
    'dash.text_align': 'Align',
    'dash.text_valign': 'Vertical',
    'dash.align_left': 'Left',
    'dash.align_center': 'Center',
    'dash.align_right': 'Right',
    'dash.valign_top': 'Top',
    'dash.valign_middle': 'Middle',
    'dash.valign_bottom': 'Bottom',
    'dash.drag_move': 'Drag to move',
    'dash.style_header1': 'Header 1',
    'dash.style_header2': 'Header 2',
    'dash.style_paragraph': 'Paragraph',
    'dash.save': 'Save',
    'dash.text_required': 'Please enter some text',
    'dash.share': '🔗 Share',
    ...
    'dash.frozen_role_denied': "Your role doesn't include this data — showing saved result",
  ...
  geo: {
    ...
    'lab.refresh_no_access': 'თქვენი როლი არ მოიცავს ამ ცხრილის მონაცემებს — განახლება მიუწვდომელია. ნაჩვენებია ბოლო შენახული შედეგი.',
    ...
    'wizard.db_already_in_chat': 'უკვე ამ ჩატშია',
    ...
    'dash.loading': 'იტვირთება…',
    'dash.back': 'ლაბში დაბრუნება',
    'dash.refresh_all': '⟳ ყველას განახლება',
    'dash.add_header': '＋ სათაური',
    'dash.add_text_title': 'ტექსტური ბლოკი',
    'dash.edit_text': 'ტექსტის რედაქტირება',
    'dash.text_placeholder': 'თქვენი ტექსტი…',
    'dash.text_style': 'სტილი',
    'dash.text_size': 'ზომა',
    'dash.text_align': 'სწორება',
    'dash.text_valign': 'ვერტიკალური',
    'dash.align_left': 'მარცხნივ',
    'dash.align_center': 'ცენტრში',
    'dash.align_right': 'მარჯვნივ',
    'dash.valign_top': 'ზემოთ',
    'dash.valign_middle': 'შუაში',
    'dash.valign_bottom': 'ქვემოთ',
    'dash.drag_move': 'გადასატანად გადაათრიეთ',
    'dash.style_header1': 'სათაური 1',
    'dash.style_header2': 'სათაური 2',
    'dash.style_paragraph': 'აბზაცი',
    'dash.save': 'შენახვა',
    'dash.text_required': 'გთხოვთ შეიყვანოთ ტექსტი',
    ...
    'dash.frozen_role_denied': 'თქვენი როლი არ მოიცავს ამ მონაცემებს — ნაჩვენებია შენახული შედეგი',
    ...
    'profile.db_config': 'ბაზის კონფიგურაცია',
  ...
  ru: {
    ...
    'lab.refresh_no_access': 'Ваша роль не включает данные этой таблицы — обновление недоступно. Показан последний сохранённый результат.',
    ...
    'wizard.db_already_in_chat': 'Уже в этом чате',
    ...
    'dash.add_header': '＋ Заголовок',
    'dash.add_text_title': 'Текстовый блок',
    'dash.edit_text': 'Редактировать текст',
    'dash.text_placeholder': 'Ваш текст…',
    'dash.text_style': 'Стиль',
    'dash.text_size': 'Размер',
    'dash.text_align': 'Выравнивание',
    'dash.text_valign': 'По вертикали',
    'dash.align_left': 'По левому краю',
    'dash.align_center': 'По центру',
    'dash.align_right': 'По правому краю',
    'dash.valign_top': 'Сверху',
    'dash.valign_middle': 'По середине',
    'dash.valign_bottom': 'Снизу',
    'dash.drag_move': 'Перетащите, чтобы переместить',
    'dash.style_header1': 'Заголовок 1',
    'dash.style_header2': 'Заголовок 2',
    'dash.style_paragraph': 'Абзац',
    'dash.save': 'Сохранить',
    'dash.text_required': 'Пожалуйста, введите текст',
    ...
    'dash.frozen_role_denied': 'Ваша роль не включает эти данные — показан сохранённый результат',
    ...
    'profile.db_config': 'Конфигурация БД',
