...
window.I18N_TRANSLATIONS = {
  en: {
    ...
    'wizard.db_tables_title': '🗄️ Add database tables',
    'wizard.db_tables_search': 'Search tables…',
    'lab.data_sources': '🗄️ Data sources',
  ...
  geo: {
    ...
    'wizard.db_tables_title': '🗄️ მონაცემთა ბაზის ცხრილების დამატება',
    'wizard.db_tables_search': 'ცხრილების ძებნა…',
    'lab.data_sources': '🗄️ მონაცემთა წყაროები',
  ...
  ru: {
    ...
    'wizard.db_tables_title': '🗄️ Добавить таблицы базы данных',
    'wizard.db_tables_search': 'Поиск таблиц…',
    'lab.data_sources': '🗄️ Источники данных',
